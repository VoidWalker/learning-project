...
$firstBook = new Book('n1 Core PHP Programming, Third Edition', 'Atkinson and Suraski');
$secondBook = new Book('n2 PHP Bible', 'Converse and Park');
$thirdBook = new Book('n3 Design Patterns', 'Gamma, Helm, Johnson, and Vlissides');
